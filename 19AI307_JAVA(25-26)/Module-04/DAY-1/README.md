...
## QUESTION:
Write a program that reads 4 strings from the user.
For each input:
If it can be converted to an integer → print
Parsed number: <number>
If conversion fails (NumberFormatException) → print
Not a valid number
...
<img width="737" height="325" alt="image" src="https://github.com/user-attachments/assets/af94721e-c33d-4fd7-851d-29d31d345852" />
