...
4. Create a ContactDAO interface with:
       - addContact(Contact contact)
       - getContactsStartingWith(char letter)
5. Implement ContactDAOImpl to store contacts in an ArrayList.
6. In addContact(), add Contact objects to the list.
7. In getContactsStartingWith(), loop through the list and filter contacts
   whose names begin with the given letter.
...
<img width="583" height="759" alt="image" src="https://github.com/user-attachments/assets/f5b558df-303f-491b-9b55-5e249f3b4656" />
