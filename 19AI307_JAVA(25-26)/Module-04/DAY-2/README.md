...
## QUESTION:
In a gaming lounge there is one master console power switch that controls all gaming consoles.
Whenever any player turns on a console it internally triggers the master power. The master switch must be a Singleton (only one instance ever created) and must keep a global access count.
For each player access print:[PlayerName] accessed Master Power Switch. Total accesses so far: [count]
...
<img width="1297" height="330" alt="image" src="https://github.com/user-attachments/assets/a64f2bd1-32e7-4cd7-830d-080b2a45235a" />
